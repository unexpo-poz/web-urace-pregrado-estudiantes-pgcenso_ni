<?php
$enProduccion		= true;
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/pgcenso_ni/';
...
$inscHabilitada		= true;
$fecha_i = '10-04-2018'; // Fecha de inicio del censo (DD-MM-AAAA).
...
//Unidad Tributaria:
$unidadTributaria	= 9648; //SUELDO MINIMO ACTUAL 2016
